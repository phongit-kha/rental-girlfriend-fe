...
export default function Register() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl px-4 mt-[40px]">
        ...
        <div className="mt-6 mb-3 grid grid-cols-2 gap-4 rounded-md bg-[#f4f6f8] p-[5px] w-[631px] ">
          <button
          ...
          >
            <Image
              src={
                activeTab === "user" ? "/img/user.svg" : "/img/userwithgray.svg"
              }
              alt="user icon"
              width={20}
              height={20}
            ...
            <span
              className={`${
                activeTab === "user" ? "text-[#F24472]" : "text-[#6b7280]"
              }`}
            >
              ลูกค้า
            </span>
          ...
          >
            ...
            <span
              className={`${
                activeTab === "provider" ? "text-[#F24472]" : "text-[#6b7280]"
              }`}
            >
              ผู้ให้บริการ
            </span>
        ...
        <div className="pt-3 text-center pb-[64px]">
