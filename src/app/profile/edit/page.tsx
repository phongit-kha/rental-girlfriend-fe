                            ...
                            <div className="h-[58px] flex gap-4">
                                {user.type === "provider" && (
                                    <div className="w-[202.5px] h-[58px] flex flex-col items-start gap-1">
                                        ...
                                        <div className="box-border flex flex-row items-center px-3 py-2 gap-2 w-[202.5px] h-[36px] border border-[#E1E7F4] rounded-md">
                                            <CreditCard className="w-4 h-4 opacity-50" />
                                            <input 
                                                type="text" 
                                                value={draft.id} onChange={(e) => handleDraftChange("id", e.target.value)} 
                                                className="h-[18px] font-normal text-[13px] leading-[140%] text-[#212B36]">
                                            </input>
                                        </div>
                                    </div>
                                )}
                            ...
                            <div className="h-[40px] flex gap-4">
                                <div className="w-[202.5px] h-[40px] flex items-center gap-2">
                                    ...
                                    <select
                                        ...
                                        className="box-border flex flex-row justify-center items-center px-3 py-2 w-20 h-10 border border-[#E1E7F4] rounded-md text-[13px] leading-[140%] text-[#212B36]"
                                    >
                                ...
                                <div  className="w-[202.5px] h-[40px] flex items-center gap-2">
                                    ...
                                    <select
                                        ...
                                        className="box-border flex flex-row justify-center items-center px-3 py-2 gap-2 w-20 h-10 border border-[#E1E7F4] rounded-md text-[13px] leading-[140%] text-[#0212B36]"
                                    >
                                        <option value="ชาย">ชาย</option>
                                        <option value="หญิง">หญิง</option>
                                        <option value="อื่นๆ">อื่นๆ</option>
                ...
                <div className="absolute w-[100%] h-[100%] top-0 left-0 bg-[rgba(33,43,54,0.5)]">
                    <div className="flex flex-col items-start p-6 px-4 gap-6 absolute w-[566px] h-[569px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl">
                        ...
                        <div className="w-[534px] h-[34px] flex justify-end items-center gap-[12px]">
                            ...
                            <button onClick={saveProfile} disabled={!tempImg} className={`flex justify-center items-center p-2 px-4 w-[121px] h-[34px] rounded-md ${tempImg ? "bg-[linear-gradient(133.15deg,#F24BA7_2.02%,#EF4444_98.99%)]" : "bg-[linear-gradient(133.15deg,#F24BA7_2.02%,#EF4444_98.99%)] opacity-70 cursor-not-allowed"}`}>
